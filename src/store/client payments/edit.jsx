...
export default function PaymentEdit(){
    ...
    const [clientName, setClientName] = useState(paymentData.client_name);
    ...
    const create = async(e)=>{
        ...
        await axios.post(`http://127.0.0.1:8000/api/store/clientPayment/${paymentData.id}`, formData,config)
        .then(({data})=>{
        ...
        <>
            <form className="p-4" onSubmit={create}>
                <div className="form-group mb-4">
                    ...
                    <input onChange={(e)=>{setDate(e.target.value)}} type="date" className="form-control" placeholder={t("Enter date")} value={date}/>
                </div>
                <div className="form-group mb-4">
